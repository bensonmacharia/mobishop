...
const DropdownUser = () => {
  ...
  const cookie = getCookie("mobiapp-session");
  ...
  if (cookie) {
    ...
    decoded = jwtDecode<JwtPayload>(cookie);
    //console.log(decoded.roles.join(", "));
  } else {
    router.push("/");
  }
      ...
      >
        <span className="hidden text-right lg:block">
          <span className="block text-sm font-medium text-black dark:text-white">
            {decoded?.fname + " " + decoded?.lname || "FirstName LastName"}
          </span>
          <span className="block text-xs">
            {decoded?.roles.join(", ") || "User"}
          </span>
        </span>
